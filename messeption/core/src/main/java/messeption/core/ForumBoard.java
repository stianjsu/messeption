...
public class ForumBoard {
  ...
  /** 
   * Saves all the information in ForumBoard on a specified file at a specified path.
   * Forumboard has a collection with the ForumPosts, hence the posts are saved.
  ...
  /** 
   * Saves all the information in ForumBoard on a default location.
   * Forumboard has a collection with the ForumPosts, hence the posts are saved.
  ...
  /** 
   * Uses ForumPosts toString method to create a string that consists of all
   * the posts in posts-list.
